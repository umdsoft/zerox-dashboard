...
const err = ref('')
const rows = ref([])       // table rows (normalized)
const page = ref(1)        // 1-based
const limit = ref(10)
const total = ref(0)       // server total if provided
...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-semibold text-slate-800">Berilgan qarz (Debitor)</h1>
    </div>
